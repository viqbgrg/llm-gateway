...
public class ProviderModelController {
    ...
    @PostMapping public Mono<ProviderModelEntity> create(@Valid @RequestBody AdminDtos.ProviderModelRequest request) { return service.save(null, request); }
    @PutMapping("/{id}") public Mono<ProviderModelEntity> update(@PathVariable String id, @Valid @RequestBody AdminDtos.ProviderModelRequest request) { return service.save(id, request); }
