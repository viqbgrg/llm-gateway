...
public class BindingController {
    ...
    @PostMapping public Mono<BindingEntity> create(@Valid @RequestBody AdminDtos.BindingRequest request) { return service.save(null, request); }
    @PutMapping("/{id}") public Mono<BindingEntity> update(@PathVariable String id, @Valid @RequestBody AdminDtos.BindingRequest request) { return service.save(id, request); }
